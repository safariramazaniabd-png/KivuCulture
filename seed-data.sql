...
FROM (VALUES
  ((SELECT id FROM user1), 'Masque Mukanda',     'Masque rituel des cérémonies Mukanda, sculpté dans du bois d''iroko. Pièce unique.',                                                          'Sculpture',  15000, 'USD', 'https://images.unsplash.com/photo-1578301978693-85fa9c0320b9?w=600&q=85&fm=webp'),
  ((SELECT id FROM user1), 'Statue Mwana Pwo',   'Figurine féminine Mwana Pwo, ancêtre fondatrice. Bois de teck patiné à la main.',                                                              'Sculpture',  22000, 'USD', 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600&q=85&fm=webp'),
  ((SELECT id FROM user1), 'Bâton de Chef',      'Bâton de commandement sculpté, motifs géométriques Shi. Bois d''ébène et incrustations laiton.',                                               'Sculpture',  28000, 'USD', 'https://images.unsplash.com/photo-1597245818917-0e557b42080b?w=600&q=85&fm=webp'),
  ((SELECT id FROM user2), 'Kivu Vert',          'Acrylique grand format : collines du Sud-Kivu au lever du soleil. Toile 120x80 cm.',                                                           'Peinture',    8500, 'USD', 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?w=600&q=85&fm=webp'),
  ((SELECT id FROM user2), 'Femme Lave',         'Portrait d''une femme Havu au bord du lac Kivu. Acrylique et collage de tissu.',                                                                'Peinture',   12000, 'USD', 'https://images.unsplash.com/photo-1583394293253-4e7fa1f8e2c3?w=600&q=85&fm=webp'),
  ((SELECT id FROM user2), 'Lueur sur le Lac',   'Série impressionniste des reflets sur le lac Kivu. Huile sur toile 60x90 cm.',                                                                  'Peinture',   10500, 'USD', 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=600&q=85&fm=webp'),
  ((SELECT id FROM user3), 'Nyiragongo #3',      'Tirage limité de l''éruption du Nyiragongo. 50 exemplaires numérotés et signés. Format 40x60 cm.',                                           'Photographie',18000, 'USD', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&q=85&fm=webp'),
  ((SELECT id FROM user3), 'Pêcheurs Tanganyika','Pêcheurs artisans au lever du jour sur le lac Tanganyika. Tirage argentique, 30 ex.',                                                         'Photographie',15500, 'USD', 'https://images.unsplash.com/photo-1494783367193-149034c05e8f?w=600&q=85&fm=webp'),
  ((SELECT id FROM user3), 'Marché de Bukavu',   'Couleurs et textures du grand marché de Bukavu. Street photography, tirage 30x45 cm.',                                                        'Photographie', 9500, 'USD', 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=600&q=85&fm=webp'),
  ((SELECT id FROM user4), 'Vannerie Bashi',     'Panier traditionnel Bashi en fibres de papyrus tressé. Teinture naturelle ocre. Diamètre 35 cm.',                                             'Artisanat',   6500, 'USD', 'https://images.unsplash.com/photo-1594999945795-e570338fdd12?w=600&q=85&fm=webp'),
  ((SELECT id FROM user4), 'Tenture Kivu',       'Tenture murale en raphia teint aux pigments naturels. Motifs géométriques Shi. 100x150 cm.',                                                  'Textile',    14000, 'USD', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=600&q=85&fm=webp'),
  ((SELECT id FROM user4), 'Natroute Kokiyo',    'Set de table en fibres de bananier tressées. Lot de 6 pièces uniques.',                                                                        'Artisanat',   3500, 'USD', 'https://images.unsplash.com/photo-1591123120672-f278488733d6?w=600&q=85&fm=webp'),
  ((SELECT id FROM user5), 'Collier Amazulu',    'Collier en perles de verre recyclé. Motifs traditionnels Havu. Longueur 45 cm + fermoir.',                                                    'Bijouterie',  4200, 'USD', 'https://images.unsplash.com/photo-1722072391426-964abfef1924?w=600&q=85&fm=webp'),
  ((SELECT id FROM user5), 'Bracelet Volcan',    'Bracelet en laiton martelé et perles de lave du Nyiragongo. Pièce unique.',                                                                     'Bijouterie',  2800, 'USD', 'https://images.unsplash.com/photo-1611652022419-a9419f74325d?w=600&q=85&fm=webp'),
  ((SELECT id FROM user5), 'Boucles Lacs',       'Boucles d''oreilles argent recyclé et turquoise. Inspirées des couleurs des lacs Kivu et Tanganyika.',                                        'Bijouterie',  3600, 'USD', 'https://images.unsplash.com/photo-1630019852942-f89202989a59?w=600&q=85&fm=webp')
